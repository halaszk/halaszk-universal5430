 ...
 *
 * ported Battery charge control for MAX77804 on UNIVERSAL5430 and MAX77843 on UNIVERSAL5433 - halaszk
 *
...
struct charge_control charge_controls[] = {
	...
	_charge("wpc_input_curr", INPUT	, POWER_SUPPLY_TYPE_WIRELESS),
	_charge("wpc_chrg_curr"	, CHARGE, POWER_SUPPLY_TYPE_WIRELESS),
};
